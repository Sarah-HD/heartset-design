...
export default function ParticipationModeling() {
  // Outreach Section
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <header className="bg-white border-b border-black/10 px-6 md:px-16 lg:px-24 py-6">
        ...
        <div>
          ...
          >
            Participation Modeling Engine
          </h1>
          <p className="text-black/60 font-light">
            Model seat velocity, revenue capacity, and margin before you ever send a message.
          </p>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white border border-black/10 p-6">
                <h3 className="text-lg font-medium mb-4 pb-3 border-b border-black/5">Sales Allocation</h3>
              ...
              <div className="bg-white border border-black/10 p-8 sticky top-6">
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <p className="text-xs text-black/40 mb-1 tracking-wide">INITIAL PARTICIPANTS (P₀)</p>
                    ...
                    <div>
                      <p className="text-xs text-black/40 mb-1 tracking-wide">REFERRAL ADDS (R₁)</p>
                    ...
                    <div>
                      <p className="text-xs text-black/40 mb-1 tracking-wide">TOTAL ROOM (TR)</p>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <p className="text-xs text-black/40 mb-1 tracking-wide">CORE SALES</p>
                    ...
                    <div>
                      <p className="text-xs text-black/40 mb-1 tracking-wide">MID SALES</p>
                    ...
                    <div>
                      <p className="text-xs text-black/40 mb-1 tracking-wide">LOW SALES</p>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <p className="text-xs text-black/40 mb-2 tracking-wide">TOTAL REVENUE</p>
                    ...
                    <div>
                      <p className="text-xs text-black/40 mb-2 tracking-wide">NET PROFIT</p>
