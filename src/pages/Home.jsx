...
export default function Home() {
  ...
  if (user) {
    // Focus group users see the full dashboard
    if (isFocusGroup) {
      return (
        <div className="min-h-screen bg-white">
          <div className="px-6 md:px-16 lg:px-24 py-16 md:py-24">
            <div className="max-w-6xl mx-auto">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16 text-center">
                ...
                <p className="text-lg text-black/60 font-light max-w-3xl mx-auto">
                  This portal hosts your Focus Group materials. Review the content and come prepared to reflect.
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                  <Card className="border-black/10 h-full">
                    <CardContent className="p-8">
                      <h2 className="text-2xl mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Program Context</h2>
                      <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded">
                        <div className="w-2 h-2 rounded-full bg-black"></div>
                        <span className="text-lg font-medium">Focus Group Intensive</span>
                      </div>
                    </CardContent>
                  </Card>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                  <Card className="border-black/10 h-full">
                    <CardContent className="p-8">
                      <h2 className="text-2xl mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Important Dates</h2>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start gap-3 text-sm">
                          ...
                          <div>
                            <p className="font-medium">Completion Target</p>
                            <p className="text-black/60">Before live session</p>
                          </div>
                        </div>
                      </div>
                    </CardContent>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="mb-12">
                <Card className="border-black/20 border-2">
                  <CardContent className="p-8">
                    <h2 className="text-3xl mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>What To Do Today</h2>
                    <div className="space-y-4">
                      <Link to={createPageUrl("VideoLibrary")} className="flex items-center gap-4 p-4 bg-neutral-50 hover:bg-neutral-100 rounded transition-colors group">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
                <Card className="border-black/10">
                  <CardContent className="p-8">
                    <h2 className="text-2xl mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>How This Session Works</h2>
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3 text-black/70"><span className="w-1.5 h-1.5 rounded-full bg-black/40 mt-2 flex-shrink-0"></span><span>Come prepared with reflections from the material</span></li>
                      <li className="flex items-start gap-3 text-black/70"><span className="w-1.5 h-1.5 rounded-full bg-black/40 mt-2 flex-shrink-0"></span><span>This is not a brainstorming session</span></li>
                      <li className="flex items-start gap-3 text-black/70"><span className="w-1.5 h-1.5 rounded-full bg-black/40 mt-2 flex-shrink-0"></span><span>Questions should relate to clarity, not customization</span></li>
                      <li className="flex items-start gap-3 text-black/70"><span className="w-1.5 h-1.5 rounded-full bg-black/40 mt-2 flex-shrink-0"></span><span>Coaching support begins in the full program</span></li>
                    </ul>
                  </CardContent>
                </Card>
              </motion.div>
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black/40 font-light">Your dashboard will be available soon.</p>
        </div>
      </div>
    );
  }
